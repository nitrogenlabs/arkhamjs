...
}}]),b}(_react.Component);Arkham.propTypes={children:_propTypes2.default.node,className:_propTypes2.default.string,config:_propTypes2.default.object,routes:_propTypes2.default.array,stores:_propTypes2.default.array},Arkham.defaultProps={config:{},routes:[],stores:[]},Arkham.childContextTypes={config:_propTypes2.default.object},exports.default=Arkham;