...
var Flux = function (_EventEmitter) {
  ...
  function Flux() {
    ...
    _this._store = _this.getSessionData('arkhamjs') || (0, _immutable.Map)();
  ...
  _createClass(Flux, [{
    ...
    value: function dispatch() {
      ...
      return list.map(function (a) {
        ...
        var _a$toJS = a.toJS(),
            type = _a$toJS.type,
            data = _objectWithoutProperties(_a$toJS, ['type']);
        ...
        _this2._storeClasses.map(function (storeClass) {
          ...
          if (_this2._useCache) {
            _this2.setSessionData('arkhamjs', _this2._store);
          }
    ...
    value: function registerStore(StoreClass) {
      ...
      if (!this._storeClasses.has(name)) {
        ...
        // Get cached data
        var data = this.getSessionData('arkhamjs');
...
var flux = new Flux((window || {}).arkhamjs);
